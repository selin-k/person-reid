...
import numpy as np
from reid.datasets import get_dataset, get_dataloaders, get_dataset_names, get_open_set_dataloaders
from reid.models import get_model, get_model_names
from reid.engine import SoftmaxEngine, TripletEngine, ReIDEngine
from reid.training_tools import WarmupMultiStepLR

import torchvision.models as models


if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Triplet loss on LUPerson")
    ...
    model_path = "saved_models/lup_moco_r50.pth"
    ...
    engine.run(
        ...
        optimizer=optimizer,
        scheduler=scheduler,
        save_dir="market1501lupersontriplet",
        test_only=False
    )
